...
ffmpeg -i "public\images\New Images\Truxor_T_Video_Generation.mp4" -vf "fps=1/2" temp_frames\frame_%04d.png

REM Extract specific key frames (adjusted for 7.79 second video)
echo.
echo Extracting key frames at specific timestamps...
ffmpeg -i "public\images\New Images\Truxor_T_Video_Generation.mp4" -ss 00:00:00 -vframes 1 temp_frames\front_view.png
ffmpeg -i "public\images\New Images\Truxor_T_Video_Generation.mp4" -ss 00:00:02 -vframes 1 temp_frames\side_view.png
ffmpeg -i "public\images\New Images\Truxor_T_Video_Generation.mp4" -ss 00:00:04 -vframes 1 temp_frames\back_view.png
ffmpeg -i "public\images\New Images\Truxor_T_Video_Generation.mp4" -ss 00:00:06 -vframes 1 temp_frames\top_view.png
...
echo.
echo Next steps:
echo 1. Go to https://polycam.ai (FREE) or https://kaedim3d.com
